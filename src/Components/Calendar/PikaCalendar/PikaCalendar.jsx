...
import styles from "./PikaCalendar.module.css";
...
const PikaBookingCalendar = ({ questName }) => {
  ...
  const formatDate = (date) => {
    ...
    const dayOfWeek = ["нд", "пн", "вт", "ср", "чт", "пт", "сб"][date.getDay()];
  ...
  return (
    <div className={styles.calendarContainer}>
      ...
      <p className={styles.cost}>
        *Базова вартість за гру вказана за 4 гравцiв, доплата за кожного наступного гравця 250 грн, максимальна кількість гравців - 8.
      </p>
...
export default PikaBookingCalendar;